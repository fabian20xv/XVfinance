...
| SpeakReadyToggle | Speak 1.5, mounted in the top bar only while the meeting workspace is open. Speak-ready sets the 1-pager body to 18/28, enlarges MeetingOnePager, and dims shell chrome to ink-muted at 40%. `R` opens and cycles the receipt side-slip (ignored while typing). Toggle off or Leave tears it down. Client-only — no `/v1` speak route |
